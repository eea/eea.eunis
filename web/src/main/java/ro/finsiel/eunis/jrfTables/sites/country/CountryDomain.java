...
import ro.finsiel.eunis.search.sites.country.CountrySearchCriteria;
import ro.finsiel.eunis.search.sites.country.CountrySortCriteria;
...
public class CountryDomain extends AbstractDomain implements Paginable {
   ...
   */
  public CountryDomain(AbstractSearchCriteria[] searchCriteria, AbstractSortCriteria[] sortCriteria, SourceDb sourceDb) {
    this.searchCriteria = searchCriteria;
    this.sortCriteria = sortCriteria;
    this.sourceDb = sourceDb;
  }

  public CountryDomain(AbstractSearchCriteria[] searchCriteria, SourceDb sourceDb) {
    this.searchCriteria = searchCriteria;
    this.sourceDb = sourceDb;
  }
  ...
  public void setup() {
    ...
    this.addColumnSpec(new StringColumnSpec("AREA", "getArea", "setArea", DEFAULT_TO_NULL));
