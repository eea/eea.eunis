 ...
 * Time: 16:26:04
 */
public class YearDomain extends AbstractDomain implements Paginable {
  ...
  private StringBuffer _prepareWhereSearch() throws CriteriaMissingException {
    ...
    for (int i = 0; i < searchCriteria.length; i++) {
      ...
      YearSearchCriteria aCriteria = (YearSearchCriteria) searchCriteria[i]; // upcast
